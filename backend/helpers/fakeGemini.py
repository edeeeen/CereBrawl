...
def generateQuizQuestion(topic, difficulty):
    if(topic == "biology"):
        if(difficulty == 1):
            ...
            return bioQuestionBank[random.randint(0, 4)]
        elif(difficulty == 2):
            bioQuestionBank = [
            ...
            bioQuestionBank = [
                ...
                "Question: What is the process by which cells engulf large particles or other cells?\nA. Exocytosis\nB. Endocytosis\nC. Phagocytosis\nD. Pinocytosis\nCorrect Answer: C"
            ]
            return bioQuestionBank[random.randint(0, 4)]
    elif(topic == "history"):
        historyQuestionBank = [
